...
const FormAcad = () => {
  let inputClass =
    "p-2 rounded-lg  mb-4 mx-7  max-[767px]:mb-4 max-[767px]:mx-3";
  ...
  return (
    <div className="p-4 h-[60vh] w-[60vh] max-[1023px]:h-auto max-[767px]:w-[370px]">
      <form
        onSubmit={SubmitHandle}
        className="py-6 flex flex-col max-[767px]:py-4"
      >
        <input
          required
          type="text"
          className={inputClass}
          // className="p-2 rounded-lg  mb-4 mx-7  max-[767px]:mb-2 max-[767px]:mx-1 "
        ...
        <div>
          ...
          <button className="p-3 bg-lime-900 my-3 whitetext rounded-xl lg:my-1">
            Submit
          </button>
