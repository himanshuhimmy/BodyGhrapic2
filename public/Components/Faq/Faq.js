  ...
  return (
    <div className="">
      <div className="w-full  overflow-hidden">
        <img
          className="w-screen h-[85vh] max-[767px]:h-auto"
          src={studioPhoto}
      ...
      <div className="Black">
        <div className="container w-full py-8">
          <h1 className="text-center yellowtext text-3xl font-bold max-[767px]:text-2xl">
          ...
          {Faqs.map((el) => {
            ...
            return (
              <div
                key={el.id}
                className="whitetext my-6 px-4  w-[90%] max-[767px]:w-full"
              >
                <div className="bg-gray-800 rounded-lg p-1">
                  <button
                    ...
                    className="font-bold w-full flex p-2 text-xl justify-between max-[767px]:font-semibold"
                  >
