...
const Contactus = () => {
  ...
  return (
    <div className="Black py-8  max-[767px]:py-4">
      <ModalRoot ref={modalRef} Button="okay">
        <div className="p-11 w-full max-[767px]:p-6">
      ...
      <div className="flex container w-full max-[1023px]:block max-[767px]:block">
        <div className="w-[50%] py-7 max-[1023px]:w-[90%] max-[1023px]:m-auto max-[767px]:w-[95%] max-[767px]:m-auto">
          <iframe
        ...
        <div className="w-[50%] px-4 max-[1023px]:w-[90%] max-[1023px]:m-auto max-[767px]:w-[95%] max-[767px]:m-auto">
          <div className="">
            <h1 className="text-2xl text-center font-bold my-3 yellowtext max-[767px]:text-xl max-[767px]:my-1">
              GET IN TOUCH
            </h1>
