...
const AboutUs = () => {
  let Pclass = "font-semibold whitetext text-center py-6";
  ...
  return (
    <div>
      ...
      <div
        className={`bg-gradient-to-b overflow-hidden from-black to-transparent  py-8 relative h-70vh`}
      >
        <div className="w-full  overflow-hidden absolute">
          <img
            className="w-full  h-full  object-cover relative mix-blend-overlay"
            src={studioPhoto}
            alt="Tattoo studio interior"
          />
        </div>
        <div className="container py-3">
          <h1 className="text-5xl text-center font-light my-4 yellowtext">
